	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<form class="form-horizontal" method="POST" id="guardar_usuario" name="guardar_usuario" enctype="multipart/form-data" autocomplete="off">
				<div id="resultados"></div>
				  ...
				  <div class="form-group">
					<label for="user_password_new" class="col-sm-3 control-label">Contrase&ntilde;a</label>
					<div class="col-sm-8">
