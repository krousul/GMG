				          ...
				          <div class="pricing-body">
				            <ul class="description">
								...
								<li class="thumbnail">
									...
									<div class="caption">
										<h3 class="title"><?php if(!empty($des['Propiedades6'])) echo $des['Propiedades6']; ?><a class="anchorjs-link" href="#thumbnail-label"><span class="anchorjs-icon"></span></a></h3>
									</div>
								    <div align="center">
				          ...
				          <div class="pricing-body">
				            <ul class="description">
								<li class="thumbnail">
									...
									<div class="caption">
										<h3 class="title"><?php if(!empty($des['Propiedades7'])) echo $des['Propiedades7']; ?><a class="anchorjs-link" href="#thumbnail-label"><span class="anchorjs-icon"></span></a></h3>
									</div>
								    <div align="center">
								...
								<li class="thumbnail">
									...
									<div class="caption">
										<h3 class="title"><?php if(!empty($des['Propiedades8'])) echo $des['Propiedades8']; ?><a class="anchorjs-link" href="#thumbnail-label"><span class="anchorjs-icon"></span></a></h3>
									</div>
								    <div align="center">
								...
								<li class="thumbnail">
									...
									<div class="caption">
										<h3 class="title"><?php if(!empty($des['Propiedades9'])) echo $des['Propiedades9']; ?><a class="anchorjs-link" href="#thumbnail-label"><span class="anchorjs-icon"></span></a></h3>
									</div>
								    <div align="center">
				          ...
				          <div class="pricing-body">
				            <ul class="description">
								<li class="thumbnail">
									...
									<div class="caption">
										<h3 class="title"><?php if(!empty($des['Propiedades10'])) echo $des['Propiedades10']; ?><a class="anchorjs-link" href="#thumbnail-label"><span class="anchorjs-icon"></span></a></h3>
									</div>
								    <div align="center">
								...
								<li class="thumbnail">
									...
									<div class="caption">
										<h3 class="title"><?php if(!empty($des['Propiedades11'])) echo $des['Propiedades11']; ?><a class="anchorjs-link" href="#thumbnail-label"><span class="anchorjs-icon"></span></a></h3>
									</div>
								    <div align="center">
								...
								<li class="thumbnail">
									...
									<div class="caption">
										<h3 class="title"><?php if(!empty($des['Propiedades12'])) echo $des['Propiedades12']; ?><a class="anchorjs-link" href="#thumbnail-label"><span class="anchorjs-icon"></span></a></h3>
									</div>
								    <div align="center">
	          ...
	          <div class="modal-body">
		         <div class="container">
		         	...
		         	<div class="row">
						<div class="form-group">
							<div class="col-sm-5">
								Titulo: <input value="<?=  $des['Propiedades1']; ?>" id="<?= $IDFORMS[MODULE_PROP][0]; ?>text1" name="<?= $IDFORMS[MODULE_PROP][0]; ?>text1" class="form-control" placeholder="Input" type="text">
							</div>
						</div>
					</div>
				</div>
	          ...
	          <div class="modal-body">
		         <div class="container">
		         	...
		         	<div class="row">
						<div class="form-group">
							<div class="col-sm-5">
								Titulo: <input value="<?=  $des['Propiedades2']; ?>" id="<?= $IDFORMS[MODULE_PROP][1]; ?>text1" name="<?= $IDFORMS[MODULE_PROP][1]; ?>text1" class="form-control" placeholder="Input" type="text">
							</div>
						</div>
					</div>
				</div>
	          ...
	          <div class="modal-body">
		         <div class="container">
		         	...
		         	<div class="row">
						<div class="form-group">
							<div class="col-sm-5">
								Titulo: <input value="<?=  $des['Propiedades3']; ?>" id="<?= $IDFORMS[MODULE_PROP][2]; ?>text1" name="<?= $IDFORMS[MODULE_PROP][2]; ?>text1" class="form-control" placeholder="Input" type="text">
							</div>
						</div>
					</div>
				</div>
	          ...
	          <div class="modal-body">
		         <div class="container">
		         	...
		         	<div class="row">
						<div class="form-group">
							<div class="col-sm-5">
								Titulo: <input value="<?=  $des['Propiedades4']; ?>" id="<?= $IDFORMS[MODULE_PROP][3]; ?>text1" name="<?= $IDFORMS[MODULE_PROP][3]; ?>text1" class="form-control" placeholder="Input" type="text">
							</div>
						</div>
					</div>
				</div>
	          ...
	          <div class="modal-body">
		         <div class="container">
		         	...
		         	<div class="row">
						<div class="form-group">
							<div class="col-sm-5">
								Titulo: <input value="<?=  $des['Propiedades5']; ?>" id="<?= $IDFORMS[MODULE_PROP][4]; ?>text1" name="<?= $IDFORMS[MODULE_PROP][4]; ?>text1" class="form-control" placeholder="Input" type="text">
							</div>
						</div>
					</div>
				</div>
	          ...
	          <div class="modal-body">
		         <div class="container">
		         	...
		         	<div class="row">
						<div class="form-group">
							<div class="col-sm-5">
								Titulo: <input value="<?=  $des['Propiedades6']; ?>" id="<?= $IDFORMS[MODULE_PROP][5]; ?>text1" name="<?= $IDFORMS[MODULE_PROP][5]; ?>text1" class="form-control" placeholder="Input" type="text">
							</div>
						</div>
					</div>
				</div>
	          ...
	          <div class="modal-body">
		         <div class="container">
		         	...
		         	<div class="row">
						<div class="form-group">
							<div class="col-sm-5">
								Titulo: <input value="<?=  $des['Propiedades7']; ?>" id="<?= $IDFORMS[MODULE_PROP][6]; ?>text1" name="<?= $IDFORMS[MODULE_PROP][6]; ?>text1" class="form-control" placeholder="Input" type="text">
							</div>
						</div>
					</div>
				</div>
	          ...
	          <div class="modal-body">
		         <div class="container">
		         	...
		         	<div class="row">
						<div class="form-group">
							<div class="col-sm-5">
								Titulo: <input value="<?=  $des['Propiedades8']; ?>" id="<?= $IDFORMS[MODULE_PROP][7]; ?>text1" name="<?= $IDFORMS[MODULE_PROP][7]; ?>text1" class="form-control" placeholder="Input" type="text">
							</div>
						</div>
					</div>
				</div>
	          ...
	          <div class="modal-body">
		         <div class="container">
		         	...
		         	<div class="row">
						<div class="form-group">
							<div class="col-sm-5">
								Titulo: <input value="<?=  $des['Propiedades9']; ?>" id="<?= $IDFORMS[MODULE_PROP][8]; ?>text1" name="<?= $IDFORMS[MODULE_PROP][8]; ?>text1" class="form-control" placeholder="Input" type="text">
							</div>
						</div>
					</div>
				</div>
	          ...
	          <div class="modal-body">
		         <div class="container">
		         	...
		         	<div class="row">
						<div class="form-group">
							<div class="col-sm-5">
								Titulo: <input value="<?=  $des['Propiedades10']; ?>" id="<?= $IDFORMS[MODULE_PROP][9]; ?>text1" name="<?= $IDFORMS[MODULE_PROP][9]; ?>text1" class="form-control" placeholder="Input" type="text">
							</div>
						</div>
					</div>
				</div>
	          ...
	          <div class="modal-body">
		         <div class="container">
		         	...
		         	<div class="row">
						<div class="form-group">
							<div class="col-sm-5">
								Titulo: <input value="<?=  $des['Propiedades11']; ?>" id="<?= $IDFORMS[MODULE_PROP][10]; ?>text1" name="<?= $IDFORMS[MODULE_PROP][10]; ?>text1" class="form-control" placeholder="Input" type="text">
							</div>
						</div>
					</div>
				</div>
	          ...
	          <div class="modal-body">
		         <div class="container">
		         	...
		         	<div class="row">
						<div class="form-group">
							<div class="col-sm-5">
								Titulo: <input value="<?=  $des['Propiedades12']; ?>" id="<?= $IDFORMS[MODULE_PROP][11]; ?>text1" name="<?= $IDFORMS[MODULE_PROP][11]; ?>text1" class="form-control" placeholder="Input" type="text">
							</div>
						</div>
					</div>
				</div>
