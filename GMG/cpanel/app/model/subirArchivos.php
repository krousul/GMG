...
class Documents extends Conexion{
	...
	{
		//obtengo un array con los par�metros enviados a la funci�n
		$params = func_get_args();
		//saco el n�mero de par�metros que estoy recibiendo
		$num_params = func_num_args();
		//cada constructor de un n�mero dado de par�mtros tendr� un nombre de funci�n
		//atendiendo al siguiente modelo __construct1() __construct2()...
		$funcion_constructor = '__construct'.$num_params;
		//compruebo si hay un constructor con ese n�mero de par�metros
		if (method_exists($this,$funcion_constructor)) {
			//si exist�a esa funci�n, la invoco, reenviando los par�metros que recib� en el constructor original
	...
	public function __construct3($module,$seccion,$idiom){
		$this->module=$module;
