<?php
	...
	foreach ($arrayServicios As $services){
		$onCLick = "onClick=\"$('#nom_servicio').text('{$services['nom_servicio']}');xajax_consultarServ('{$services['nom_servicio']}','{$services['contenido']}');$('#id_servicio').val('{$services['id_servicios']}');\";";
