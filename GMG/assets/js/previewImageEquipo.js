...
//Aqui se agregan los selectores de los archivos a subir
	      ...
	      document.getElementById('Equipo2file1').addEventListener('change', archivo, false);
	      document.getElementById('Equipo3file1').addEventListener('change', archivo, false);
	      document.getElementById('Equipo4file1').addEventListener('change', archivo, false);
